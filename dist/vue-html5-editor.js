/**
 * Vue-html5-editor 2.3.15
 * https://github.com/DreamerKing/longxi-vue-html5-editor.git
 * build at Mon Jul 27 2020 17:51:27 GMT+0800 (GMT+08:00)
 */
...
__$styleInject(".vue-html5-editor .color-card{width:16px;height:16px;cursor:pointer}.vue-html5-editor table td{margin:0;padding:1px}",undefined);
...
var editor = {
    ...
    watch: {
        ...
        characteristicList: function characteristicList (val) {
            var this$1 = this;
            ...
            if (val.length !== 0) {
              ...
              this.$emit('change', this.$refs.content.innerHTML);
              this.$nextTick(function () {
                this$1.$emit('sucmessage', '特征词插入成功');
              });
            }
          },
    ...
    methods: {
        ...
        toggleShowCode: function toggleShowCode() {
            ...
            this.$nextTick(function (){
                if(this$1.showCode) {
                    this$1.$refs.contentCode.value = this$1.content;
                } else {
                    this$1.$refs.content.innerHTML = this$1.content;
                }
            });
        },
        ...
        saveCurrentCodeRange: function saveCurrentCodeRange() {
    ...
    mounted: function mounted(){
      ...
      contentCode.addEventListener('keyup', function () {
        this$1.$emit('change', contentCode.value);
    ...
    this.touchCodeHandler = function (e) {
